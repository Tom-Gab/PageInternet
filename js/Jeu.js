...
document.getElementById("Jeu").appendChild(renderer.view);
...
function animate() {
    ...
    if (goalBox.x > 0 || goalBox.x < $(window).width - goalBox.width)
    {
        velociteX = vitesse;
    }
